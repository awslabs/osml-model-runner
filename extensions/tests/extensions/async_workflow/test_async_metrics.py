...
from ..src.osml_extensions.metrics import AsyncMetricsTracker, AsyncMetricsContext
...
class TestAsyncMetricsTracker(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        expected_timings = [
            "S3Upload", "S3Download", "AsyncEndpointInvocation",
            "QueueTime", "TotalAsyncDuration", "PollingDuration"
        ]
        ...
        expected_counters = [
            "PollingAttempts", "S3UploadRetries", "S3DownloadRetries",
            "AsyncInferenceSuccess", "AsyncInferenceFailures",
            "S3UploadSize", "S3DownloadSize"
        ]
