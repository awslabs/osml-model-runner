...
class TestS3Manager(unittest.TestCase):
    ...
    def test_validate_bucket_access_success(self):
        ...
        expected_calls = [
            unittest.mock.call(Bucket="test-input-bucket"),
            unittest.mock.call(Bucket="test-output-bucket")
        ]
...
class TestS3ManagerIntegration(unittest.TestCase):
    ...
    def test_upload_download_integration(self):
        ...
        response = self.s3_client.get_object(
            Bucket="test-input-bucket",
            Key="test-input/integration-test-key"
        )
    ...
    def test_validate_bucket_access_integration(self):
        ...
        bad_config = AsyncEndpointConfig(
            input_bucket="non-existent-bucket",
            output_bucket="test-output-bucket"
        )
