...
class TestAsyncInferencePoller(unittest.TestCase):
    ...
    def test_successful_polling_immediate_completion(self):
        ...
        self.mock_sm_client.describe_inference_recommendations_job.assert_called_once_with(JobName=self.test_inference_id)
    ...
    def test_polling_job_failed(self):
        ...
        self.mock_sm_client.describe_inference_recommendations_job.return_value = {"Status": "Failed"}
    ...
    def test_polling_timeout(self):
        ...
        self.mock_sm_client.describe_inference_recommendations_job.return_value = {"Status": "InProgress"}
    ...
    def test_get_job_status_success(self):
        ...
        expected_response = {"Status": "InProgress", "OutputLocation": None}
    ...
    def test_get_job_status_with_output(self):
        ...
        expected_response = {"Status": "Completed", "OutputLocation": self.test_output_location}
        self.mock_sm_client.describe_inference_recommendations_job.return_value = expected_response
