...
from osml_extensions.registry import HandlerRegistrationError, HandlerType, get_registry, register_handler, reset_registry
...
class TestRegisterHandlerDecorator(unittest.TestCase):
    ...
    def test_register_handler_minimal_params(self):
        ...
        @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="minimal_handler")
    ...
    def test_register_handler_empty_request_type(self):
        ...
        with self.assertRaises(HandlerRegistrationError) as context:
            ...
            @register_handler(request_type="", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="test_handler")
            class TestHandler:
                pass
    ...
    def test_register_handler_invalid_handler_type(self):
        ...
        with self.assertRaises(HandlerRegistrationError) as context:
            ...
            @register_handler(request_type="test_type", handler_type="invalid_type", name="test_handler")
            class TestHandler:
                pass
    ...
    def test_register_handler_empty_name(self):
        ...
        with self.assertRaises(HandlerRegistrationError) as context:
            ...
            @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="")
            class TestHandler:
                pass
    ...
    def test_register_handler_none_class(self):
        ...
        with self.assertRaises(HandlerRegistrationError):
            decorator = register_handler(
                request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="test_handler"
            )
            decorator(None)
    ...
    def test_register_handler_returns_class(self):
        ...
        @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="test_handler")
        class TestHandler:
    ...
    def test_register_handler_logging(self, mock_logger):
        ...
        mock_logger.info.assert_called_with("Successfully registered handler 'test_handler' for request_type='test_type'")
    ...
    def test_register_multiple_handlers(self):
        ...
        @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="region_handler")
        class RegionHandler:
            pass

        @register_handler(request_type="test_type", handler_type=HandlerType.IMAGE_REQUEST_HANDLER, name="image_handler")
        class ImageHandler:
            pass
    ...
    def test_register_handler_override(self):
        ...
        @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="first_handler")
        class FirstHandler:
            pass

        @register_handler(request_type="test_type", handler_type=HandlerType.REGION_REQUEST_HANDLER, name="second_handler")
        class SecondHandler:
            pass
