...
class TestRegistryIntegration(unittest.TestCase):
    ...
    def test_endpoint_configuration_inference(self):
        ...
        async_endpoint_config = {
            "endpoint_name": "my-async-sagemaker-endpoint",
            "endpoint_type": "async_sagemaker"
        }
        
        region_metadata, image_metadata = self.selector.select_handlers(
            endpoint_config=async_endpoint_config
        )
        ...
        region_metadata, image_metadata = self.selector.select_handlers(
            endpoint_config=sm_endpoint_config
        )
