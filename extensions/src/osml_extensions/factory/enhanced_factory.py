...
class EnhancedFeatureDetectorFactory(FeatureDetectorFactory):
    ...
    def __init__(self, endpoint: str, endpoint_mode: ModelInvokeMode, 
        ...
        logger.info(f"EnhancedFeatureDetectorFactory initialized - "
    ...
    def get_factory_info(self) -> Dict[str, str]:
        """
        Get information about the factory configuration for debugging.
        
        :return: Dict[str, str] = Factory configuration information
        """
        return {
            'endpoint': self.endpoint,
