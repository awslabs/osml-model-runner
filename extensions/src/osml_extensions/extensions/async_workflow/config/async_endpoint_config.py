...
class AsyncEndpointConfig:
    ...
    def _load_from_environment(self) -> None:
        ...
        self.exponential_backoff_multiplier = float(os.getenv("ASYNC_SM_BACKOFF_MULTIPLIER", str(self.exponential_backoff_multiplier)))
        ...
        self.enable_worker_optimization = os.getenv("ASYNC_SM_WORKER_OPTIMIZATION", str(self.enable_worker_optimization)).lower() == "true"
