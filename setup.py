...
setup(
    name="AWSOversightMLModelRunner",
    version="1.0",
    ...
    #    src/aws_oversightml_model_runner/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/AWSOversightMLModelRunner (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # AWSOversightMLModelRunner = aws_oversightml_model_runner.cli:main
    # """,
    #
