...
class TestRegionRequestTable(unittest.TestCase):
    def setUp(self):
        ...
        from aws_oversightml_model_runner.database.region_request_table import (
            RegionRequestItem,
            RegionRequestTable,
        )
    ...
    def test_region_started_success(self):
        """
        Validate we can start an region, and it gets created in the table
        """
        from aws_oversightml_model_runner.database.region_request_table import RegionRequestStatus

        self.region_request_table.start_region_request(self.region_request_item)
        resulting_region_request_item = self.region_request_table.get_region_request(
            TEST_REGION_ID, TEST_IMAGE_ID
        )
    ...
    def test_start_region_failure_exception(self):
        ...
        """
        from aws_oversightml_model_runner.database.exceptions import StartRegionException
