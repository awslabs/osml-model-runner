...
def test_gdal_sensor_model():
    ...
    assert np.array_equal(world_coordinate.coordinate, np.array([radians(0.4), radians(0.9), 0.0]))
...
def test_gdal_sensor_model_real_example():
    transform = (
        -43.681640625,
...
def test_gdal_non_invertable_transform():
