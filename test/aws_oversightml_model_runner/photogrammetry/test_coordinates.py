...
def test_worldcoordinate_list_constructor():
...
def test_imagecoordinate_list_constructor():
...
def test_geodeticworldcoordinate_default_constructor():
...
def test_geodeticworldcoordinate_bad_values():
    with pytest.raises(ValueError) as value_error:
