...
class TestFeatureRefinery(unittest.TestCase):
    def setUp(self) -> None:
        from aws_oversightml_model_runner.tile_worker.feature_refinery import FeatureRefinery
    ...
    def build_sensor_model():
        from aws_oversightml_model_runner.gdal import SensorModelFactory, SensorModelTypes
