...
class TestStatusMonitor(TestCase):
    def setUp(self) -> None:
        ...
        from aws_oversightml_model_runner.database.job_table import JobItem
        from aws_oversightml_model_runner.status import StatusMonitor
        ...
        sns_response = sns.create_topic(Name=TEST_ENV_CONFIG.get("IMAGE_STATUS_TOPIC"))
    ...
    def test_process_event(self):
        from aws_oversightml_model_runner.common.typing import ImageRequestStatus
        ...
        expected_message = (
            f"StatusMonitor update: {mock_status.value} {self.job_item.job_id}: {mock_message}"
        )
    ...
    def test_process_event_sns_failure(self):
        from aws_oversightml_model_runner.common.typing import ImageRequestStatus
        from aws_oversightml_model_runner.status import StatusMonitorException
