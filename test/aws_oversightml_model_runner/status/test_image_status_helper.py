...
class TestImageStatusHelper(TestCase):
    def setUp(self):
        ...
        from aws_oversightml_model_runner.sink.s3_sink import S3Sink
        ...
        self.mock_model_hosting_type = ModelHostingOptions.NONE
    ...
    def test_image_status_item_to_dict_of_strings(self):
        from aws_oversightml_model_runner.status.image_request_status import (
            ImageRequestStatusMessage,
        )
        ...
        mock_item = ImageRequestStatusMessage(
            ...
            model_hosting_type=self.mock_model_hosting_type,
        ...
        expected_dict_of_strings = {
            ...
            "model_hosting_type": str(self.mock_model_hosting_type.value),
            "model_invocation_role": self.mock_model_invocation_role,
