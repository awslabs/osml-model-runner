...
def test_chip_generator():
    ...
    chip_list = []
    for chip in generate_crops_for_region(((150, 150), (5000, 5000)), (2048, 2048), (1024, 1024)):
        chip_list.append(chip)


def test_invalid_chip_generator():
    with pytest.raises(ValueError):
        chip_list = []
        for chip in generate_crops_for_region(((5, 10), (1024, 1024)), (300, 300), (301, 0)):
            chip_list.append(chip)

    with pytest.raises(ValueError):
        chip_list = []
        for chip in generate_crops_for_region(((5, 10), (1024, 1024)), (300, 300), (0, 301)):
            chip_list.append(chip)
