...
def test_feature_selection_empty_list():
    """
...
def test_feature_selection_none_list():
    """
...
def test_feature_selection_nms_no_overlap():
    """
...
def test_feature_selection_nms_overlaps():
    """
...
def test_feature_selection_no_selection():
    """
...
def test_feature_selection_unknown_algorithm():
    """
    ...
    with pytest.raises(FeatureDistillationException):
        feature_selector.select_features(original_features)


def test_feature_selection_nms_overlaps_custom_threshold():
    """
...
def test_feature_selection_nms_overlaps_multiple_categories():
    """
...
def test_feature_selection_nms_point_feature():
    """
...
def test_feature_selection_soft_nms_overlaps():
    """
...
def test_feature_selection_soft_nms_single_feature():
    """
