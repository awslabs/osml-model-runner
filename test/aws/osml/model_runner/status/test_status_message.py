...
def test_asdict(status_message):
    ...
    assert status_message.asdict() == expected_dict


def test_asdict_str_values(status_message):
    ...
    assert status_message.asdict_str_values() == expected_dict_str


def test_asdict_with_missing_fields():
...
def test_asdict_str_values_processing_duration():
    ...
    assert dict_str_values["processing_duration"] == "3000"


def test_asdict_str_values_failed_tiles():
    ...
    dict_str_values = status_message.asdict_str_values()
    assert dict_str_values["failed_tiles"] == "[{'1': [[1, 2], [3, 4]]}]"
