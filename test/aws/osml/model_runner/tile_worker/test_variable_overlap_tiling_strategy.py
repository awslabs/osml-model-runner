...
def test_compute_regions_full_image():
    """
...
def test_compute_regions_tiny_image():
    """
...
def test_compute_tiles_tiny_region():
    """
...
def test_deconflict_features(mocker):
    """
    ...
    mock_feature_selector = mocker.Mock(wraps=DummyFeatureSelector())
