...
def test_timer_with_normalized_unit(mocker):
    from aws.osml.model_runner.common import Timer

    mock_logger = mocker.Mock()
    mock_metrics_logger = mocker.Mock()
    mock_metrics_logger.put_metric = mocker.Mock()
...
def test_timer_without_normalized_unit(mocker):
    from aws.osml.model_runner.common import Timer
...
def test_timer_use_milliseconds(mocker):
    from aws.osml.model_runner.common import Timer
...
def test_timer_metrics_logger_none(mocker):
    from aws.osml.model_runner.common import Timer
...
def test_timer_throw_exception(mocker):
    from aws.osml.model_runner.common import Timer
