...
def test_unsubscribe_handler():
    ...
    event()
    assert not mock_handler_called
...
def test_handler_with_arguments():
    ...
    assert received_args == ("test", 123)
    assert received_kwargs == {"keyword": "value"}
...
def test_subscribe_same_handler_multiple_times():
