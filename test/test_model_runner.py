...
def test_calculate_processing_bounds_no_roi(test_dataset_and_camera):
    ...
    sensor_model = test_dataset_and_camera[1]

    processing_bounds = calculate_processing_bounds(None, ds, sensor_model)
...
def test_process_region_request_noop_model(
    ...
    mock_job_table.complete_region.assert_called_with(region_request.image_id)
...
def test_sizeof_fmt():
    from aws_oversightml_model_runner.app import sizeof_fmt
