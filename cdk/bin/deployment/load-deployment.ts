 ...
 *   "mrDataplaneConfig": {
 *     "containerUri": "awsosml/osml-model-runner:latest",
 *     "ecsTaskCpu": 2048,
 *     "ecsTaskMemory": 4096
 *   }
 * }
...
import { ModelRunnerDataplaneConfig } from "../../lib/constructs/model-runner-dataplane";
...
export function loadDeploymentConfig(): DeploymentConfig {
  ...
  let mrDataplaneConfig: DeploymentConfig['dataplaneConfig'] = undefined;
  if (parsed.mrDataplaneConfig && typeof parsed.mrDataplaneConfig === 'object') {
    mrDataplaneConfig = parsed.mrDataplaneConfig;
  }
