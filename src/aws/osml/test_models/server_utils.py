...
def detect_to_feature(
    ...
    :param model_name: Model name to include in model metadata
    :return: dict: Dictionary representation of a geojson feature
    """

    resolved_model_name = model_name or "centerpoint"
    feature = {
        "type": "Feature",
        "geometry": None,
        "id": token_hex(16),
        "properties": {
            ...
            "modelMetadata": {
                ...
                "ontologyName": resolved_model_name,
...
def parse_custom_attributes_header(custom_attributes: Optional[str]) -> Dict[str, str]:
    """
    Parse the SageMaker CustomAttributes header string.
...
def parse_custom_attributes() -> Dict[str, str]:
    ...
    return parse_custom_attributes_header(custom_attributes)
