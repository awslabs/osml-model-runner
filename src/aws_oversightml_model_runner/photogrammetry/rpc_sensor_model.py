...
class RPCSensorModel(SensorModel):
    ...
    def world_to_image(self, geodetic_coordinate: GeodeticWorldCoordinate) -> ImageCoordinate:
        ...
        cn = self.samp_numerator_poly(norm_domain_coordinate) / self.samp_denominator_poly(
            norm_domain_coordinate
        )
        rn = self.line_numerator_poly(norm_domain_coordinate) / self.line_denominator_poly(
            norm_domain_coordinate
        )
