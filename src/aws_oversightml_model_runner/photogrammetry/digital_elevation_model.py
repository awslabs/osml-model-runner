...
class DigitalElevationModel(ElevationModel):
    ...
    def __init__(
        ...
        :param tile_set: a class used to identify the DEM tile associated with a specific location
        :param tile_factory: a class used to load the DEM tile and convert it to a numpy array
        :param raster_cache_size: the number of DEM arrays to store in memory preventing frequent loading
        """
        super().__init__()
    ...
    def set_elevation(self, geodetic_world_coordinate: GeodeticWorldCoordinate) -> None:
        ...
        if interpolation_grid is not None and sensor_model is not None:
            ...
            geodetic_world_coordinate.elevation = interpolation_grid(
    ...
    def get_interpolation_grid(
        self, tile_path: str
    ) -> Tuple[Optional[interp2d], Optional[SensorModel]]:
        """
        ...
        :param tile_path: the location of the tile to load
        :return: the cached interpolation object and sensor model or None,None
        """
