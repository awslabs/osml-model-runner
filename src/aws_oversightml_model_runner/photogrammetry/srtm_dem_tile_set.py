...
class SRTMTileSet(DigitalElevationModelTileSet):
    ...
    def __init__(self, prefix: str = "", version: str = "1arc_v3", format_extension: str = ".tif"):
        """
    ...
    def find_tile_id(self, geodetic_world_coordinate: GeodeticWorldCoordinate) -> Optional[str]:
        ...
        It appears they are following a convention of:
           <latitude degrees>_<longitude degrees>_<resolution>_<version><format>
        ...
        # The SRTM mission only covers latitudes N59 through S56 so if the requested location is outside of those
