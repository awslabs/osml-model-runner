...
class ServiceConfig:
    ...
    self_throttling: bool = (
        ...
        or os.getenv("SM_SELF_THROTTLING", "False") == "true"
    )
...
class BotoConfig:
    ...
    default: Config = Config(
        region_name=ServiceConfig.aws_region, retries={"max_attempts": 15, "mode": "standard"}
    )
    sagemaker: Config = Config(
        region_name=ServiceConfig.aws_region, retries={"max_attempts": 30, "mode": "adaptive"}
    )
