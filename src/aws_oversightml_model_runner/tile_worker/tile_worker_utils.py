...
from aws_oversightml_model_runner.api import RegionRequest
...
from aws_oversightml_model_runner.database import FeatureTable
from aws_oversightml_model_runner.gdal import GDALConfigEnv, get_type_and_scales
from aws_oversightml_model_runner.inference import FeatureDetector
from aws_oversightml_model_runner.photogrammetry import ElevationModel, SensorModel
from aws_oversightml_model_runner.tile_worker import FeatureRefinery, TileWorker
...
def setup_tile_workers(
    ...
    try:
        ...
        for _ in range(int(ServiceConfig.workers)):
            ...
            worker = TileWorker(
                tile_queue, feature_detector, feature_refinery, feature_table, metrics
            )
            worker.start()
